...
# Last Modified time: 2019-04-22 10:10:06
...
class CreatedEvernoteToken(object):
    ...
    def __init__(self, username, password, cfgpath):
        ...
        self.headers = {
            ...
            'Referer': 'https://app.yinxiang.com/Login.action?targetUrl=%2Fapi%2FDeveloperToken.action',
            'X-Requested-With': 'XMLHttpRequest',
            'User-Agent': 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_14_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/73.0.3683.103 Safari/537.36',
        }
        self.login_url = "https://app.yinxiang.com/Login.action?targetUrl=%2Fapi%2FDeveloperToken.action"
